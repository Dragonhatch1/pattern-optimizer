...
local json = ensureFile("dkjson.lua", "https://raw.githubusercontent.com/Dragonhatch1/pattern-optimizer/refs/heads/master/src/lua/dkjson.lua")
local argparse = ensureFile("argparse.lua", "https://raw.githubusercontent.com/Dragonhatch1/pattern-optimizer/refs/heads/master/src/lua/argparse.lua")
package.loaded.machines = nil -- Do not use cached version since user likely changes settings frequently
local machines = ensureFile("machines.lua", "https://raw.githubusercontent.com/Dragonhatch1/pattern-optimizer/refs/heads/master/src/lua/machines.lua")
